...
version = pynecktie.__version__
# The full version, including alpha/beta/rc tags.
release = pynecktie.__version__
...
htmlhelp_basename = 'pyNecktieDoc'
...
latex_documents = [(master_doc, 'pyNecktie.tex', 'pyNecktie Documentation',
                    'pyNecktie contributors', 'manual'), ]

# -- Options for manual page output ---------------------------------------

# One entry per manual page. List of tuples
# (source start file, name, description, authors, manual section).
man_pages = [(master_doc, 'pynecktie', 'pyNecktie Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'pyNecktie', 'pyNecktie Documentation', author, 'pyNecktie',
